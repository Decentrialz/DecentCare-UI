          ...
          <ol className="space-y-3">
            {stages.map((stage) => (
              ...
              >
                ...
                <div className={`flex w-[112px] shrink-0 flex-col items-center justify-center px-3 text-center ${
                  stage.tone === "start"
                    ? ""
                    : `border-l ${stage.tone === "treated" ? "border-[#83d8d2]" : "border-[#dce9f1]"}`
                }`}>
                  <p className={`text-2xl lg:text-3xl leading-none font-extrabold ${stage.tone === "treated" ? "text-home-success" : "text-home-heading"}`}>
                    {stage.value}
                  </p>
                  <p className={`mt-2 rounded bg-[#fff0eb] px-2 py-1 text-xs font-bold ${stage.tone === "start" ? "bg-[#eef8fb] text-home-heading" : "text-home-danger"}`}>
                    {stage.note}
                  </p>
                </div>
              </li>
