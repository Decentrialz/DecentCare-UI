...
const HowWeWorkSection = () => (
  <section className="py-20 lg:py-28 bg-[#FBFCFD]">
    <div className="container mx-auto px-4 lg:px-8 text-center">
      <h2 className="text-md md:text-xl lg:text-2xl font-bold text-primary mb-3" style={{
      ...
      <div className="grid md:grid-cols-4 gap-18 max-w-5xl mx-auto">
        {howWeWork.map((step, i) => (
          <div key={i} className="relative text-left rounded-2xl p-6 pt-10" style={{ backgroundColor: 'rgba(13, 92, 148, 0.06)', border: '1px solid rgba(255, 255, 255, 0.6)' }}>
            <div className="absolute -top-4 left-[-20] w-12 h-12 rounded-full flex items-center justify-center text-sm font-bold text-white" style={{ background: "linear-gradient(135deg, #0D9488, #0D5C94)" }}>
              {step.step}
            </div>
