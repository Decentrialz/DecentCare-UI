...
const TrustedBySection = () => (
  <section className="py-16 bg-[#FBFCFD]">
    <div className="container mx-auto px-4 lg:px-8 text-center">
      <h3 className="text-xl md:text-2xl font-bold text-primary-foreground mb-8" style={{
     ...
     <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-12 justify-items-center items-center" style={{ maxWidth: '1100px', margin: '0 auto' }}>
