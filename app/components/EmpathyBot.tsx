        ...
        <div className="bg-card rounded-3xl p-8 lg:p-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-[#627384] mt-[-20px]">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#3C83F6]/10 rounded-xl p-4">
                  <div className="text-3xl font-bold text-accent" style={{ background: 'linear-gradient(135deg, #0D9488, #0D5C94)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>95%</div>
                  <div className="text-sm text-muted-foreground">Response Accuracy</div>
                </div>
                <div className="bg-[#3C83F6]/10 rounded-xl p-4">
                  <div className="text-3xl font-bold text-primary" style={{ background: 'linear-gradient(135deg, #0D9488, #0D5C94)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>24/7</div>
